...
class ModelCriteria extends BaseModelCriteria
{
    ...
    public function useIndex($indexName, $scope = null){
        $this->addIndexHint($this->getModelShortName(), $indexName, Criteria::INDEX_USE, $scope);
        
        return $this;
    }
    
    public function forceIndex($indexName, $scope = null){
        $this->addIndexHint($this->getModelShortName(), $indexName, Criteria::INDEX_FORCE, $scope);
        
        return $this;
    }
    
    public function ignoreIndex($indexName, $scope = null){
        $this->addIndexHint($this->getModelShortName(), $indexName, Criteria::INDEX_IGNORE, $scope);
